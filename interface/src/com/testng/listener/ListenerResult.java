...
public class ListenerResult extends TestListenerAdapter {
	...
	private StackTraceElement[] getAllStackTraceElement(ITestResult tr, Error e, Throwable throwable,
		...
		StackTraceElement[] message = new StackTraceElement[] {
				new StackTraceElement("message : " + msg + " in method : ", tr.getMethod().getMethodName(),

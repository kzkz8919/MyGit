...
public class TestDataExtend2 {

	private String fileName;
	private ParseXml px;
	private Map<String, String> commonData;

	public TestDataExtend2(String fileName) {
	...
	public List<Map<String, String>> getTestMethodData(String methodName) {
		...
		for (Element element : elements) {
			Map<String, String> dataMap = px.getChildrenInfoByElement(element);
			Map<String, String> commonData = this.getMergeMapData(this.getCommonData(), Global.global);
			Map<String, String> data = this.getMergeMapData(dataMap, commonData);
			listData.add(data);
		}
		return listData;
	}
